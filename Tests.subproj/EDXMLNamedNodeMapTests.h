...
#ifndef	__EDXMLNamedNodeMapTests_h_INCLUDE
#define	__EDXMLNamedNodeMapTests_h_INCLUDE

#import <Foundation/Foundation.h>
#import <SenTestingKit/SenTestingKit.h>

@class EDXMLDocument, EDXMLElement, EDXMLNamedNodeMap;


@interface EDXMLNamedNodeMapTests : SenTestCase
{
    EDXMLDocument		*document;
    EDXMLElement 		*owner;
    EDXMLNamedNodeMap	*map;
}
